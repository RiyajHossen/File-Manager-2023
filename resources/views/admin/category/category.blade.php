    ...
    <div id="content">
        <form action="categories" method="post" class="secdiv">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ctnm" id="ctnm" class="form-control" required value="{{old('ctnm')}}">
                @error('ctnm')
                    ...
                    <tbody>
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td><a href="editcat/{{ $category['id'] }}">Edit</a> <a
                                        href="category/delete/{{ $category['id'] }}">Delete</a></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
